...
COUNTRY_PHONE_PREFIX = os.environ["COUNTRY_PHONE_PREFIX"]
...
def send_password_reset_link(phone, token, baseurl):
    ...
    endpointurl = reverse("kolibri:kolibri_instant_schools_plugin:passwordchange_list")
    ...
    send_message(phone, SMS_MESSAGE_TEMPLATE.format(url=url))
...
def send_message(phone, message):
    ...
    if not phone.startswith(COUNTRY_PHONE_PREFIX):
